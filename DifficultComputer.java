...
public class DifficultComputer{
    ...
    public static String pickSpot(String v, String[] gameboard){
        for(int i=1;i<=9;i+=3){
            if(gameboard[i].equals(v)&&gameboard[i+1].equals(v)&&!gameboard[i+2].equals(v)){
                return gameboard[i+2];
            }else if(gameboard[i].equals(v)&&!gameboard[i+1].equals(v)&&gameboard[i+2].equals(v)){
        ...
        for(int i=1;i<=3;i++){
            if(gameboard[i].equals(v)&&gameboard[i+3].equals(v)&&!gameboard[i+6].equals(v)){
                return gameboard[i+6];
            }else if(gameboard[i].equals(v)&&!gameboard[i+3].equals(v)&&gameboard[i+6].equals(v)){
